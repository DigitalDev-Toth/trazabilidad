<?
$wado = "http://biovision.gotdns.com:8080/wado?requestType=WADO";
	...
	<body>
		...
		<? if($series_pk) { ?>
		   <object class='visor'
			  ...
			  <param name='FlashVars' value='<? echo "series_pk=$series_pk&numImages=$i&$pat_name&$pat_age&$study_desc&$serie_desc&$institution&$pat_sex&$imagesTxt"; ?>'>
				<embed class='visor'
				  src='<? echo $script; ?>'
				  quality='high'
				  scale='noscale'
				  ...
				  FlashVars='<? echo "series_pk=$series_pk&numImages=$i&$pat_name&$pat_age&$study_desc&$serie_desc&$institution&$pat_sex&$imagesTxt"; ?>'
				/>
			</object>
		<? } ?>
		</div>
