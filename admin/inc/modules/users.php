...
//if(findRole($module, "show_roles")) {
	//$users->insertLinkInShow("roles", "#", "../images/role.png", 'onclick="PopupCenter('."'main.php?module=users_roles&###'".', '."'roles'".', 800, 600)"', "Permisos", NULL, array("table"=>"users_roles", "field"=>"users", "image"=>"../images/roleBack.png"));
//}
